...
tokenizer0 = SmilesTokenizer.from_pretrained('../rxnfp/transformers/bert_mlm_1k_tpl')
...
np.save('rxnfp/'+filename+'_tok.npy', alltok)
np.save('rxnfp/'+filename+'_lab.npy', alllab)
np.save('rxnfp/'+filename+'_att.npy', allatt)
np.save('rxnfp/'+filename+'_msk.npy', allmsk)
